...
@Component({
  selector: 'app-uomcreationlist',
  templateUrl: './uomcreationlist.component.html',
  styleUrls: ['./uomcreationlist.component.css']
})
export class UomcreationlistComponent {
  @ViewChild(GridviewComponent) gridView:GridviewComponent;

  public mastersGridColumns ="uomCreationGridColumns";
  public masterGridData="getUomCreation";
  public paramKey=["_id"];
